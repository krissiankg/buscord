    ...
    <section className="px-4 py-10 md:px-6 gs-reveal">
      <div className="mx-auto max-w-7xl overflow-hidden rounded-3xl bg-primary md:rounded-[40px]">
        <div className="relative flex flex-col items-center justify-center px-8 py-16 text-center md:px-12 md:py-20">
          ...
          <h2 className="relative mb-4 max-w-3xl text-3xl font-bold leading-tight text-white md:text-4xl lg:text-5xl">
            Votre projet pourrait être notre{' '}
            <span className="font-serif-italic font-normal">prochaine réalisation</span>
          </h2>
          <p className="relative mb-8 max-w-xl text-sm text-white/70 md:text-base">
            Discutons de la façon dont BUSCORD peut accompagner votre organisation sur le terrain.
          </p>
          <Link
            href="/contact"
